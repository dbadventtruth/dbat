...
#define GET_TRAININT(ch)  char_stats_get(ch, STAT_INTELLIGENCE_TRAIN)
#define GET_TRAINCON(ch)  char_stats_get(ch, STAT_CONSTITUTION_TRAIN)
#define GET_TRAINWIS(ch)  char_stats_get(ch, STAT_WISDOM_TRAIN)
#define GET_TRAINAGL(ch)  char_stats_get(ch, STAT_AGILITY_TRAIN)
#define GET_TRAINSPD(ch)  char_stats_get(ch, STAT_SPEED_TRAIN)
