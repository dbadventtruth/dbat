...
/* Evasion and improved evasion are not actually feats, but we treat them like
 * feats just to make it easier */
...
struct feat_info {
  ...
  int can_learn; /* TRUE or FALSE, can the feat be learned or is it an automatic
                    feat? */
