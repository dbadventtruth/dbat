...
#define GM_COST(i, j, k)                                                       \
  (int)(GM_CHARGE(i) * spell_info[j].min_level[(int)GET_CLASS(k)])
...
#define TRAIN_ARCANE_ARCHER(i)                                                 \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYARCANE_ARCHER))
#define TRAIN_ARCANE_TRICKSTER(i)                                              \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYARCANE_TRICKSTER))
...
#define TRAIN_DRAGON_DISCIPLE(i)                                               \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYDRAGON_DISCIPLE))
#define TRAIN_DUELIST(i) (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYDUELIST))
#define TRAIN_DWARVEN_DEFENDER(i)                                              \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYDWARVEN_DEFENDER))
#define TRAIN_ELDRITCH_KNIGHT(i)                                               \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYELDRITCH_KNIGHT))
#define TRAIN_HIEROPHANT(i) (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYHIEROPHANT))
#define TRAIN_HORIZON_WALKER(i)                                                \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYHORIZON_WALKER))
#define TRAIN_LOREMASTER(i) (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYLOREMASTER))
#define TRAIN_MYSTIC_THEURGE(i)                                                \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYMYSTIC_THEURGE))
#define TRAIN_SHADOWDANCER(i)                                                  \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYSHADOWDANCER))
#define TRAIN_THAUMATURGIST(i)                                                 \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_ONLYTHAUMATURGIST))
...
#define NOTRAIN_ARCANE_ARCHER(i)                                               \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOARCANE_ARCHER))
#define NOTRAIN_ARCANE_TRICKSTER(i)                                            \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOARCANE_TRICKSTER))
...
#define NOTRAIN_DRAGON_DISCIPLE(i)                                             \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NODRAGON_DISCIPLE))
#define NOTRAIN_DUELIST(i) (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NODUELIST))
#define NOTRAIN_DWARVEN_DEFENDER(i)                                            \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NODWARVEN_DEFENDER))
#define NOTRAIN_ELDRITCH_KNIGHT(i)                                             \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOELDRITCH_KNIGHT))
#define NOTRAIN_HIEROPHANT(i) (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOHIEROPHANT))
#define NOTRAIN_HORIZON_WALKER(i)                                              \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOHORIZON_WALKER))
#define NOTRAIN_LOREMASTER(i) (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOLOREMASTER))
#define NOTRAIN_MYSTIC_THEURGE(i)                                              \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOMYSTIC_THEURGE))
#define NOTRAIN_SHADOWDANCER(i)                                                \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOSHADOWDANCER))
#define NOTRAIN_THAUMATURGIST(i)                                               \
  (IS_SET_AR((GM_WITH_WHO(i)), TRADE_NOTHAUMATURGIST))
