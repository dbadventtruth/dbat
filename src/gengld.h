...
#define MSG_TRAINER_DISLIKE_ALIGN                                              \
  "Get out of here before I get angry, you are not aligned with me!"
...
#define MSG_TRAINER_MINLVL                                                     \
  "You are not of a skilled enough level to recieve my training."
