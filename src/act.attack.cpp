  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (pry > rand_number(1, 140) &&
            (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
          act("@C$N@W parries your headbutt with an attack of $S own!@n", TRUE,
              ch, 0, vict, TO_CHAR);
          act("@WYou parry @C$n's@W headbutt with an attack of your own!@n",
              TRUE, ch, 0, vict, TO_VICT);
          act("@C$N@W parries @c$n's@W headbutt with an attack of $S own!@n",
              TRUE, ch, 0, vict, TO_NOTVICT);
          improve_skill(vict, SKILL_PARRY, 0);
          pcost(ch, 0, stcost / 2);
          pcost(vict, 0, GET_MAX_HIT(vict) / 500);
          ...
          act("@C$N@W blocks @c$n's@W headbutt!@n", TRUE, ch, 0, vict,
              TO_NOTVICT);
          improve_skill(vict, SKILL_BLOCK, 0);
          pcost(ch, 0, stcost / 2);
          pcost(vict, 0, GET_MAX_HIT(vict) / 500);
          ...
          act("@C$N@W dodges @c$n's@W headbutt!@n", TRUE, ch, 0, vict,
              TO_NOTVICT);
          improve_skill(vict, SKILL_DODGE, 0);
          pcost(ch, 0, stcost / 2);
          hurt(0, 0, ch, vict, NULL, 0, 0);
          ...
          act("@WYou can't believe it, your headbutt misses!@n", TRUE, ch, 0,
              vict, TO_CHAR);
          act("@C$n@W throws a headbutt at you, but thankfully misses!@n", TRUE,
              ch, 0, vict, TO_VICT);
          act("@c$n@W throws a headbutt at @C$N@W, but misses!@n", TRUE, ch, 0,
              vict, TO_NOTVICT);
          pcost(ch, 0, stcost / 2);
          hurt(0, 0, ch, vict, NULL, 0, 0);
      ...
      switch (hitspot) {
      case 1:
        act("@WYou grab @c$N@W by the shoulders and slam your head into $S "
            "chest!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W grabs YOU by the shoulders and slams $s head into YOUR "
            "chest!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W grabs @c$N@W by the shoulders and slams $s head into "
            "@c$N's@W chest!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
      ...
      case 3:
        ...
        break;
      case 4: /* Weak */
        act("@WYou grab @c$N@W and barely manage to slam your head into $S "
            "leg!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W grabs YOU and barely manages to slam $s head into YOUR "
            "leg!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W grabs @c$N@W and barely manages to slam $s head into "
            "@c$N's@W leg!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        hurt(0, 0, ch, vict, NULL, dmg, 0);
  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (pry > rand_number(1, 140) &&
            (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
          act("@C$N@W parries your bash with an attack of $S own!@n", TRUE, ch,
              0, vict, TO_CHAR);
          act("@WYou parry @C$n's@W bash with an attack of your own!@n", TRUE,
              ch, 0, vict, TO_VICT);
          act("@C$N@W parries @c$n's@W bash with an attack of $S own!@n", TRUE,
              ch, 0, vict, TO_NOTVICT);
          improve_skill(vict, SKILL_PARRY, 0);
          pcost(ch, 0, stcost / 2);
          pcost(vict, 0, GET_MAX_HIT(vict) / 500);
          ...
          act("@WYou can't believe it, your bash misses!@n", TRUE, ch, 0, vict,
              TO_CHAR);
          act("@C$n@W throws a bash at you, but thankfully misses!@n", TRUE, ch,
              0, vict, TO_VICT);
          act("@c$n@W throws a bash at @C$N@W, but misses!@n", TRUE, ch, 0,
              vict, TO_NOTVICT);
          pcost(ch, 0, stcost / 2);
          hurt(0, 0, ch, vict, NULL, 0, 0);
        ...
        act("@C$n@W throws a bash at you, but thankfully misses!@n", TRUE, ch,
            0, vict, TO_VICT);
        act("@c$n@W throws a bash at @C$N@W, but misses!@n", TRUE, ch, 0, vict,
            TO_NOTVICT);
        hurt(0, 0, ch, vict, NULL, 0, 0);
      ...
      switch (hitspot) {
      case 1:
        act("@WBending over slightly you aim your body at @c$N@W and instantly "
            "launch yourself toward $M at full speed! You slam into $S body "
            "with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W bends over slightly aiming $s body at YOU and then "
            "instantly launches $mself toward YOU at full speed! @C$n@W slams "
            "into YOUR body with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W bends over slightly aiming $s body at @c$N@W and then "
            "instantly launches $mself toward $M at full speed! @C$n@W slams "
            "into $S body with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 2: /* Critical */
        act("@WBending over slightly you aim your body at @c$N@W and instantly "
            "launch yourself toward $M at full speed! You slam into $S head "
            "with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W bends over slightly aiming $s body at YOU and then "
            "instantly launches $mself toward YOU at full speed! @C$n@W slams "
            "into YOUR head with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W bends over slightly aiming $s body at @c$N@W and then "
            "instantly launches $mself toward $M at full speed! @C$n@W slams "
            "into $S head with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 0);
        hurt(0, 0, ch, vict, NULL, dmg, 0);
        dam_eq_loc(vict, 3);
      ...
      case 3:
        act("@WBending over slightly you aim your body at @c$N@W and instantly "
            "launch yourself toward $M at full speed! You slam into $S gut "
            "with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W bends over slightly aiming $s body at YOU and then "
            "instantly launches $mself toward YOU at full speed! @C$n@W slams "
            "into YOUR gut with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W bends over slightly aiming $s body at @c$N@W and then "
            "instantly launches $mself toward $M at full speed! @C$n@W slams "
            "into $S gut with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 4: /* Weak */
        act("@WBending over slightly you aim your body at @c$N@W and instantly "
            "launch yourself toward $M at full speed! You slam into $S leg "
            "with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W bends over slightly aiming $s body at YOU and then "
            "instantly launches $mself toward YOU at full speed! @C$n@W slams "
            "into YOUR leg with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W bends over slightly aiming $s body at @c$N@W and then "
            "instantly launches $mself toward $M at full speed! @C$n@W slams "
            "into $S leg with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        hurt(0, 0, ch, vict, NULL, dmg, 0);
        dam_eq_loc(vict, 2);
      ...
      case 5: /* Weak */
        act("@WBending over slightly you aim your body at @c$N@W and instantly "
            "launch yourself toward $M at full speed! You slam into $S arm "
            "with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W bends over slightly aiming $s body at YOU and then "
            "instantly launches $mself toward YOU at full speed! @C$n@W slams "
            "into YOUR arm with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W bends over slightly aiming $s body at @c$N@W and then "
            "instantly launches $mself toward $M at full speed! @C$n@W slams "
            "into $S arm with a crashing impact!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        hurt(0, 0, ch, vict, NULL, dmg, 0);
        dam_eq_loc(vict, 1);
