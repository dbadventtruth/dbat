...
#define SKFLAG_NEEDTRAIN                                                       \
  (1 << 0) /* Disallow use of 0 skill with only stat mod */
...
struct spell_info_type {
  ...
  const char
      *name; /* Input size not limited. Originates from string constants. */
  const char *wear_off_msg; /* Input size not limited. Originates from string
                               constants. */
