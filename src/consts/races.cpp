...
const struct aging_data racial_aging_data[NUM_RACES] = {
    /*                   adult	start1	start2	start3	middle	old	vener.
       maxdice	*/
...
const char *race_names[NUM_RACES + 1] = {
    "human",  "saiyan",   "icer",       "konatsu",    "namekian",
    "mutant", "kanassan", "halfbreed",  "bioandroid", "android",
    "demon",  "majin",    "kai",        "truffle",    "hoshijin",
    "animal", "saiba",    "serpent",    "ogre",       "yardratian",
    "arlian", "dragon",   "mechanical", "spirit",     "\n"};

const char *race_abbrevs[NUM_RACES + 1] = {
    "Hum", "Sai", "Ice", "Kon", "Nam", "Mut", "Kan", "H-B", "Bio",
    "And", "Dem", "Maj", "Kai", "Tru", "Hos", "Ict", "Sab", "Ser",
    "Trl", "Dra", "Arl", "Mnd", "Mec", "Spi", "\n"};
...
const char *d_race_types[NUM_RACES + 1] = {"A Disguised Human",
                                           "A Disguised Saiyan",
                                           "A Disguised Icer",
                                           "A Disguised Konatsu",
