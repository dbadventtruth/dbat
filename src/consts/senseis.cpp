...
const char *sensei_style[MAX_SENSEI] = {"Kame Arts",         /* Roshi */
...
const char *class_abbrevs[NUM_CLASSES + 1] = {
    "Ro", "Pi", "Kr", "Na", "Ba", "Gi", "Fr", "Ta", "An", "Da", "Ki",
    "Ji", "Ts", "Ku", "As", "Bl", "Dd", "Du", "Dw", "Ek", "Ht", "Hw",
    "Lo", "Mt", "Sh", "Th", "Ex", "Ad", "Co", "Ar", "Wa", "\n"};

/* Copied from the SRD under OGL, see ../doc/srd.txt for information */
const char *pc_class_types[NUM_CLASSES + 1] = {"Roshi",
                                               "Piccolo",
                                               "Krane",
                                               "Nail",
                                               "Bardock",
...
/* Copied from the SRD under OGL, see ../doc/srd.txt for information */
const char *class_names[NUM_CLASSES + 1] = {"roshi",
                                            "piccolo",
                                            "krane",
                                            "nail",
                                            "bardock",
