...
#define NOTRADE_BARBARIAN(i)                                                   \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOBARBARIAN))
#define NOTRADE_HALFBREED(i)                                                   \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOHALFBREED))
...
#define NOTRADE_ARCANE_ARCHER(i)                                               \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOARCANE_ARCHER))
#define NOTRADE_ARCANE_TRICKSTER(i)                                            \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOARCANE_TRICKSTER))
...
#define NOTRADE_BLACKGUARD(i)                                                  \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOBLACKGUARD))
#define NOTRADE_DRAGON_DISCIPLE(i)                                             \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NODRAGON_DISCIPLE))
#define NOTRADE_DUELIST(i) (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NODUELIST))
#define NOTRADE_DWARVEN_DEFENDER(i)                                            \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NODWARVEN_DEFENDER))
#define NOTRADE_ELDRITCH_KNIGHT(i)                                             \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOELDRITCH_KNIGHT))
#define NOTRADE_HIEROPHANT(i)                                                  \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOHIEROPHANT))
#define NOTRADE_HORIZON_WALKER(i)                                              \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOHORIZON_WALKER))
#define NOTRADE_LOREMASTER(i)                                                  \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOLOREMASTER))
#define NOTRADE_MYSTIC_THEURGE(i)                                              \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOMYSTIC_THEURGE))
#define NOTRADE_SHADOWDANCER(i)                                                \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOSHADOWDANCER))
#define NOTRADE_THAUMATURGIST(i)                                               \
  (IS_SET_AR(SHOP_TRADE_WITH((i)), TRADE_NOTHAUMATURGIST))
