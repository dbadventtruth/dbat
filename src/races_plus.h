...
enum SoftCapType : uint8_t { Fixed = 0, Variable = 1 };

class Race {
public:
  Race(race_id rid, const std::string &name, std::string abbr, int size,
       bool pc);
  ...
  std::optional<transform_bonus> findForm(char_data *ch,
